...
export default function ReportsScreen() {
  ...
  const filteredReports = reports.filter((report) => {
    ...
    const reportDate = dayjs(report.response_time);
  ...
  const handlePlayAudio = (
    ...
    setSelectedAudio({ uid, audioUrl, storyName, studentName });
  };
  ...
  return (
    <div>
                  ...
                  {filteredReports.length > 0 ? (
                    filteredReports.map((report) => (
                      <TableRow key={report.uid}>
                        ...
                        <TableCell>
                          {report.apiResponseTime.toFixed(2)}s
                        </TableCell>
                        <TableCell>
      ...
      <Dialog open={!!selectedAudio} onClose={() => setSelectedAudio([])}>
